...
- [Specification: Ballerina HTTP Library](#specification-ballerina-http-library)
  ...
  - [2. Components](#2-components)
    ...
    - [2.3. Resource](#23-resource)
      ...
      - [2.3.4. Signature parameters](#234-signature-parameters)
        - [2.3.4.1. http:Caller](#2341-httpcaller)
        - [2.3.4.2. http:Request](#2342-httprequest)
        - [2.3.4.3. Query parameter](#2343-query-parameter)
        - [2.3.4.4. Payload parameter](#2344-payload-parameter)
        - [2.3.4.5. Header parameter](#2345-header-parameter)
      - [2.3.4. Return types](#234-return-types)
      - [2.3.4.1. Status Code Response](#2341-status-code-response)
      - [2.3.4.2. Return nil](#2342-return-nil)
    ...
    - [2.4. Client](#24-client)
      - [2.4.1 Client types](#241-client-types)
        ...
        - [2.4.2. Client action](#242-client-action)
        ...
        - [2.4.3. Client action return types](#243-client-action-return-types)
  ...
  - [8. Interceptor and Error handling](#8-interceptor-and-error-handling)
    - [8.1 Interceptor](#81-interceptor)
      - [8.1.1 Request interceptor](#811-request-interceptor)
        - [8.1.1.1 RequestContext](#8111-requestcontext)
      ...
      - [8.1.3 Engaging Interceptors](#813-engaging-interceptors)
  ...
  - [9. Security](#9-security)
    - [9.1 Authentication and Authorization](#91-authentication-and-authorization)
      - [9.1.1 Declarative Approach](#911-declarative-approach)
        ...
        - [9.1.1.7 Client - Self-Signed JWT](#9117-client---self-signed-jwt)
      ...
      - [9.1.2 Imperative Approach](#912-imperative-approach)
        ...
        - [9.1.2.7. Self-Signed JWT](#9127-self-signed-jwt)
